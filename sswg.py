...
for target_file in files:
    ...
    #     # print(line)
    #     original_line = line
    #     is_code_comment = is_in_code_block and not line.strip() in ('#text',)
    ...
    #             elif line.startswith('# ') and not is_in_code_block: # h3
    #                 new_text += f'<h3>{line}</h3>'
    ...
    #             div_id = f'id="code_block_{code_block_id}" ' if is_in_code_block else ''
    ...
    #         elif is_in_code_block: # keep comments in code blocks
    ...
    #         new_text += line
    #         if not is_image_button and not is_in_code_block and not is_in_style_tag and not line.endswith('style>'):
    #             new_text += '<br>'
